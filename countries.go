...
// func getIsoToGeonameID(db *sql.DB) map[string]int {
...
// 		)
// 		if e == nil {
// 			isoToGeonameID[r.iso] = toInt(r.geonameid)
// 		} else {
// 			log.Fatal(err)
// 		}
// 	}

// 	return isoToGeonameID
// }

// func prepareCountries(db *sql.DB) {
// 	rows, err := db.Query(`
// 		SELECT
// 			"iso",
// 			"iso3",
